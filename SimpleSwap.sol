...
contract SimpleSwap {
    ...
    function addLiquidity(
        ...
        if (reserveA == 0 && reserveB == 0) {
            ...
            liquidity = min(
                amountA.mul(liquidityToken.totalSupply()) / reserveA,
                amountB.mul(liquidityToken.totalSupply()) / reserveB
            );
        }
        ...
        // Actualiza reservas
        reserves[tokenA][tokenB].reserveA = reserveA.add(amountA);
        reserves[tokenA][tokenB].reserveB = reserveB.add(amountB);
    ...
    function removeLiquidity(
        ...
        // Actualiza reservas
        reserves[tokenA][tokenB].reserveA = reserveA.sub(amountA);
        reserves[tokenA][tokenB].reserveB = reserveB.sub(amountB);
    ...
    function swapExactTokensForTokens(
        ...
        // Actualiza reservas
        reserve.reserveA = reserveIn.add(amountIn);
        reserve.reserveB = reserveOut.sub(amountOut);
    ...
    function getPrice(address tokenA, address tokenB) external view returns (uint price) {
        ...
        price = reserve.reserveB.mul(1e18).div(reserve.reserveA);
    }
